...
nietzsche = Thinker.create([{name: 'Nietzsche', url: 'http://en.wikipedia.org/wiki/Nietzsche', email: 'Nietzsche@email.com'}]).first
descartes = Thinker.create([{name: 'Descartes', url: 'http://en.wikipedia.org/wiki/Descartes', email: 'Descartes@email.com'}]).first
aristotle = Thinker.create([{name: 'Aristotle', url: 'http://en.wikipedia.org/wiki/Aristotle', email: 'Aristotle@email.com'}]).first
plato = Thinker.create([{name: 'Plato', url: 'http://en.wikipedia.org/wiki/Plato', email: 'Plato@email.com'}]).first
socrates = Thinker.create([{name: 'Socrates', url: 'http://en.wikipedia.org/wiki/Socrates', email: 'Socrates@email.com'}]).first
