...
2.) Fill in the fields and press "Submit". If any input is erroneous for this form or any other form on the site (ex. letters when there should be numbers, trying to register a username that's already taken), the form will either notify you or reset with blank fields, or both.
3.) The site should redirect to a login page. Log in with the username and password you just created.
4.) The site will initially prompt you to join a community or make a new community. Follow the steps below.


Joining a Community:

1.) If you aren't on the community selection page and are logged in, click "Community" in the top nav bar. Otherwise, go to step 3 (ex. if you're logging in for the first time, skip to step 3).
2.) Click "Change Community" from the drop-down menu.
3.) You should now be at the community selection page. Select a community to join from the "Join a community" drop down menu.
