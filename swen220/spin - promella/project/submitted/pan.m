...
{	static int reported9 = 0;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC :init: */
	case 8: /* STATE 1 - shift-alt-esc1.pml:227 - [foodArray[0] = CHILI] (0:5:4 - 1) */
		IfNotBlocked
		reached[3][1] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 9: /* STATE 5 - shift-alt-esc1.pml:231 - [(run Customer(CHILI,0))] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][5] = 1;
		if (!(addproc(0, 4, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: /* STATE 6 - shift-alt-esc1.pml:232 - [(run Customer(SANDWICH,1))] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][6] = 1;
		if (!(addproc(0, 3, 1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: /* STATE 7 - shift-alt-esc1.pml:233 - [(run Customer(PIZZA,2))] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][7] = 1;
		if (!(addproc(0, 2, 2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: /* STATE 8 - shift-alt-esc1.pml:234 - [(run Cashier())] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][8] = 1;
		if (!(addproc(1, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: /* STATE 9 - shift-alt-esc1.pml:235 - [(run Server())] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][9] = 1;
		if (!(addproc(2, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 14: /* STATE 11 - shift-alt-esc1.pml:237 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[3][11] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Server */
	case 15: /* STATE 1 - shift-alt-esc1.pml:193 - [custID = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 16: /* STATE 2 - shift-alt-esc1.pml:193 - [(custID<=2)] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][2] = 1;
		(((int)((P2 *)this)->_4_custID)<=2);
		_m = 3; goto P999; /* 0 */
	case 17: /* STATE 3 - shift-alt-esc1.pml:195 - [(custOrderSent[custID])] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][3] = 1;
		if (!(((int)now.custOrderSent[ Index(((int)((P2 *)this)->_4_custID), 3) ])))
			continue;
		_m = 3; goto P999; /* 0 */
	case 18: /* STATE 4 - shift-alt-esc1.pml:28 - [((serverMutex[0]>0))] (9:0:3 - 1) */
		IfNotBlocked
		reached[2][4] = 1;
		...
		_m = 3; goto P999; /* 2 */
	case 19: /* STATE 9 - shift-alt-esc1.pml:198 - [serverBusy[0] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][9] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 20: /* STATE 10 - shift-alt-esc1.pml:199 - [printf('Server retrieves & creates customer %d's order of %e\\n',custID,customerOrder[custID])] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][10] = 1;
		...
		_m = 3; goto P999; /* 0 */
	case 21: /* STATE 11 - shift-alt-esc1.pml:200 - [printf('Server delivers customer %d his order of %e\\n',custID,customerOrder[custID])] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][11] = 1;
		Printf("Server delivers customer %d his order of %e\n", ((int)((P2 *)this)->_4_custID), now.customerOrder[ Index(((int)((P2 *)this)->_4_custID), 3) ]);
		_m = 3; goto P999; /* 0 */
	case 22: /* STATE 12 - shift-alt-esc1.pml:201 - [orderFulfilled[custID] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][12] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 23: /* STATE 13 - shift-alt-esc1.pml:27 - [serverMutex[0] = (serverMutex[0]+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][13] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 24: /* STATE 15 - shift-alt-esc1.pml:203 - [serverBusy[0] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][15] = 1;
		(trpt+1)->bup.oval = ((int)now.serverBusy[0]);
		now.serverBusy[0] = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: /* STATE 16 - shift-alt-esc1.pml:208 - [cashierBusy = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[2][16] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 26: /* STATE 17 - shift-alt-esc1.pml:209 - [receivedOrder = 0] (0:27:2 - 1) */
		IfNotBlocked
		reached[2][17] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 27: /* STATE 18 - shift-alt-esc1.pml:210 - [(((!(custOrderSent[0])&&!(custOrderSent[1]))&&!(custOrderSent[2])))] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][18] = 1;
		if (!((( !(((int)now.custOrderSent[0]))&& !(((int)now.custOrderSent[1])))&& !(((int)now.custOrderSent[2])))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 28: /* STATE 19 - shift-alt-esc1.pml:211 - [printf('Server waits for an order to come in\\n')] (0:27:1 - 1) */
		IfNotBlocked
		reached[2][19] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 29: /* STATE 21 - shift-alt-esc1.pml:213 - [(1)] (27:0:1 - 1) */
		IfNotBlocked
		reached[2][21] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 30: /* STATE 24 - shift-alt-esc1.pml:193 - [custID = (custID+1)] (0:27:1 - 4) */
		IfNotBlocked
		reached[2][24] = 1;
		(trpt+1)->bup.oval = ((int)((P2 *)this)->_4_custID);
		((P2 *)this)->_4_custID = (((int)((P2 *)this)->_4_custID)+1);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 31: /* STATE 33 - shift-alt-esc1.pml:217 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][33] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Cashier */
	case 32: /* STATE 1 - shift-alt-esc1.pml:157 - [custID = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 33: /* STATE 2 - shift-alt-esc1.pml:157 - [(custID<=2)] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][2] = 1;
		(((int)((P1 *)this)->_3_custID)<=2);
		_m = 3; goto P999; /* 0 */
	case 34: /* STATE 3 - shift-alt-esc1.pml:161 - [(((customerWaiting[custID]&&!(custPlacedOrder[custID]))&&!(someCustSelected)))] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][3] = 1;
		if (!(((((int)now.customerWaiting[ Index(((int)((P1 *)this)->_3_custID), 3) ])&& !(((int)now.custPlacedOrder[ Index(((int)((P1 *)this)->_3_custID), 3) ])))&& !(((int)now.someCustSelected)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 35: /* STATE 4 - shift-alt-esc1.pml:28 - [((cashierMutex>0))] (9:0:2 - 1) */
		IfNotBlocked
		reached[1][4] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 36: /* STATE 9 - shift-alt-esc1.pml:164 - [custOrderSent[custID] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][9] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 10 - shift-alt-esc1.pml:165 - [cashierBusy = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][10] = 1;
		(trpt+1)->bup.oval = ((int)now.cashierBusy);
		now.cashierBusy = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 38: /* STATE 11 - shift-alt-esc1.pml:166 - [someCustSelected = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][11] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 39: /* STATE 12 - shift-alt-esc1.pml:168 - [(((custPlacedOrder[custID]&&!(serverBusy[0]))&&!(orderTaken[custID])))] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][12] = 1;
		if (!(((((int)now.custPlacedOrder[ Index(((int)((P1 *)this)->_3_custID), 3) ])&& !(((int)now.serverBusy[0])))&& !(((int)now.orderTaken[ Index(((int)((P1 *)this)->_3_custID), 3) ])))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 40: /* STATE 13 - shift-alt-esc1.pml:170 - [orderTaken[custID] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][13] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 41: /* STATE 14 - shift-alt-esc1.pml:171 - [custOrderSent[custID] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][14] = 1;
		(trpt+1)->bup.oval = ((int)now.custOrderSent[ Index(((int)((P1 *)this)->_3_custID), 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 42: /* STATE 15 - shift-alt-esc1.pml:172 - [printf('Cashier selects customer %d and takes his order of %e\\n',custID,customerOrder[custID])] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][15] = 1;
		...
		_m = 3; goto P999; /* 0 */
	case 43: /* STATE 16 - shift-alt-esc1.pml:173 - [printf('Cashier sends customer %d's order of %e to the server\\n',custID,customerOrder[custID])] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][16] = 1;
		Printf("Cashier sends customer %d's order of %e to the server\n", ((int)((P1 *)this)->_3_custID), now.customerOrder[ Index(((int)((P1 *)this)->_3_custID), 3) ]);
		_m = 3; goto P999; /* 0 */
	case 44: /* STATE 17 - shift-alt-esc1.pml:174 - [custsOrder = foodArray[custID]] (0:0:2 - 1) */
		IfNotBlocked
		reached[1][17] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		_m = 3; goto P999; /* 0 */
	case 45: /* STATE 18 - shift-alt-esc1.pml:27 - [cashierMutex = (cashierMutex+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[1][18] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 46: /* STATE 20 - shift-alt-esc1.pml:176 - [((!(someCustPlacedOrder)&&(custID==2)))] (29:0:1 - 1) */
		IfNotBlocked
		reached[1][20] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 47: /* STATE 23 - shift-alt-esc1.pml:179 - [(1)] (29:0:1 - 1) */
		IfNotBlocked
		reached[1][23] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 48: /* STATE 26 - shift-alt-esc1.pml:157 - [custID = (custID+1)] (0:29:1 - 5) */
		IfNotBlocked
		reached[1][26] = 1;
		(trpt+1)->bup.oval = ((int)((P1 *)this)->_3_custID);
		((P1 *)this)->_3_custID = (((int)((P1 *)this)->_3_custID)+1);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 49: /* STATE 35 - shift-alt-esc1.pml:183 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][35] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Customer */
	case 50: /* STATE 1 - shift-alt-esc1.pml:120 - [((customerWaiting[id]==0))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][1] = 1;
		if (!((((int)now.customerWaiting[ Index(((P0 *)this)->id, 3) ])==0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 51: /* STATE 2 - shift-alt-esc1.pml:121 - [printf('Customer %d enters store\\n',id)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][2] = 1;
		Printf("Customer %d enters store\n", ((P0 *)this)->id);
		_m = 3; goto P999; /* 0 */
	case 52: /* STATE 3 - shift-alt-esc1.pml:122 - [custPlacedOrder[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 53: /* STATE 4 - shift-alt-esc1.pml:123 - [orderFulfilled[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][4] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 54: /* STATE 5 - shift-alt-esc1.pml:124 - [customerWaiting[id] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 55: /* STATE 6 - shift-alt-esc1.pml:126 - [(!(cashierBusy))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][6] = 1;
		if (!( !(((int)now.cashierBusy))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 56: /* STATE 7 - shift-alt-esc1.pml:28 - [((customerMutex[id]>0))] (11:0:1 - 1) */
		IfNotBlocked
		reached[0][7] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 57: /* STATE 11 - shift-alt-esc1.pml:128 - [customerOrder[id] = foodArray[id]] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][11] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 58: /* STATE 12 - shift-alt-esc1.pml:129 - [printf('Customer %d tells Cashier he wants %e\\n',id,foodArray[id])] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][12] = 1;
		Printf("Customer %d tells Cashier he wants %e\n", ((P0 *)this)->id, now.foodArray[ Index(((P0 *)this)->id, 4) ]);
		_m = 3; goto P999; /* 0 */
	case 59: /* STATE 13 - shift-alt-esc1.pml:130 - [custPlacedOrder[id] = 1] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][13] = 1;
		(trpt+1)->bup.oval = ((int)now.custPlacedOrder[ Index(((P0 *)this)->id, 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 60: /* STATE 14 - shift-alt-esc1.pml:132 - [(orderFulfilled[id])] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][14] = 1;
		if (!(((int)now.orderFulfilled[ Index(((P0 *)this)->id, 3) ])))
			continue;
		_m = 3; goto P999; /* 0 */
	case 61: /* STATE 15 - shift-alt-esc1.pml:133 - [customerWaiting[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][15] = 1;
		(trpt+1)->bup.oval = ((int)now.customerWaiting[ Index(((P0 *)this)->id, 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 62: /* STATE 16 - shift-alt-esc1.pml:134 - [custPlacedOrder[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][16] = 1;
		(trpt+1)->bup.oval = ((int)now.custPlacedOrder[ Index(((P0 *)this)->id, 3) ]);
		now.custPlacedOrder[ Index(((P0 *)this)->id, 3) ] = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 63: /* STATE 17 - shift-alt-esc1.pml:135 - [orderFulfilled[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][17] = 1;
		(trpt+1)->bup.oval = ((int)now.orderFulfilled[ Index(((P0 *)this)->id, 3) ]);
		now.orderFulfilled[ Index(((P0 *)this)->id, 3) ] = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 64: /* STATE 18 - shift-alt-esc1.pml:136 - [printf('*C%d's order has been fulfilled and he leaves the restauraunt\\n',id)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][18] = 1;
		Printf("*C%d's order has been fulfilled and he leaves the restauraunt\n", ((P0 *)this)->id);
		_m = 3; goto P999; /* 0 */
	case 65: /* STATE 19 - shift-alt-esc1.pml:138 - [custOrderSent[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][19] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 66: /* STATE 20 - shift-alt-esc1.pml:139 - [orderTaken[id] = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][20] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 67: /* STATE 21 - shift-alt-esc1.pml:140 - [customerOrder[id] = NONE] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][21] = 1;
		(trpt+1)->bup.oval = now.customerOrder[ Index(((P0 *)this)->id, 3) ];
		...
		;
		_m = 3; goto P999; /* 0 */
	case 68: /* STATE 22 - shift-alt-esc1.pml:141 - [someCustSelected = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][22] = 1;
		(trpt+1)->bup.oval = ((int)now.someCustSelected);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 69: /* STATE 23 - shift-alt-esc1.pml:27 - [customerMutex[id] = (customerMutex[id]+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][23] = 1;
		(trpt+1)->bup.oval = ((int)now.customerMutex[ Index(((P0 *)this)->id, 3) ]);
		now.customerMutex[ Index(((P0 *)this)->id, 3) ] = (((int)now.customerMutex[ Index(((P0 *)this)->id, 3) ])+1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 70: /* STATE 32 - shift-alt-esc1.pml:146 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][32] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
