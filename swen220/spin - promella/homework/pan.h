...
#define PanSource	"IceCreamRace-Activity-JonO'Brien.pml"
...
#define nstates1	11	/* P */
#define endstate1	10
short src_ln1 [] = {
	  0,  44,  45,  46,  47,  43,  49,  42, 
	 54,  54,  55,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "IceCreamRace-Activity-JonO'Brien.pml", 1, 10 },
	{ ""-"", 11, 12 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   0,   1,   1,   0, 
...
#define nstates0	11	/* M */
#define endstate0	10
short src_ln0 [] = {
	  0,  25,  26,  27,  28,  24,  30,  23, 
	 35,  35,  36,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "IceCreamRace-Activity-JonO'Brien.pml", 1, 10 },
...
#define Air1	(sizeof(P1) - Offsetof(P1, _3_gotit) - 1*sizeof(uchar))
#define PM	((P0 *)this)
typedef struct P0 { /* M */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
...
#define Air0	(sizeof(P0) - Offsetof(P0, _2_gotit) - 1*sizeof(uchar))
