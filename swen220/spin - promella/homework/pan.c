...
/*** From source: IceCreamRace-Activity-JonO'Brien.pml ***/
...
{	int j, h = now._nr_pr;
	...
	case 1:	/* P */
		...
		/* params: */
		/* locals: */
		((P1 *)pptr(h))->_3_gotit = 0;
#ifdef VAR_RANGES
		logval("P:gotit", ((P1 *)pptr(h))->_3_gotit);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* M */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_2_gotit = 0;
#ifdef VAR_RANGES
		logval("M:gotit", ((P0 *)pptr(h))->_2_gotit);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	byte   gotit:	%d\n", ((P1 *)pptr(pid))->_3_gotit);
		break;
	case 0:
		printf("local vars proc %d (M):\n", pid);
	printf("	byte   gotit:	%d\n", ((P0 *)pptr(pid))->_2_gotit);
		break;
	}
}
void
...
{
	switch (x) {
	case 1: Printf("PETE"); break;
	case 2: Printf("MIKE"); break;
	case 3: Printf("NO_ONE"); break;
	default: Printf("%d", x);
	}
}
void
